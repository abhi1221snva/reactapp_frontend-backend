...
class InitiatedNonTimezoneRvmDropBySipNameCron extends Command
{
    protected $signature = 'app:send:initiated-non-timezone-rvm-drop-by-sip-trunk  {--clientId=}';
    ...
    public function handle()
    {
        ...
        $rvm_cdr_log = RvmCdrLog::where('api_token', 'bc6c')->where('status', '=', 'initiated')->where('updated_at', '<', $date)->orderBy('id', 'desc')->limit(200)->get()->all();
