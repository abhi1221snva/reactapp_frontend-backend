...
class TwilioBulkSmsJob extends Job
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            Log::error('TwilioBulkSmsJob: cannot build service', ['err' => $e->getMessage()]);
            return;
        }
        ...
        foreach ($this->recipients as $to) {
            try {
                ...
                Log::warning('TwilioBulkSmsJob: SMS failed', ['to' => $to, 'err' => $e->getMessage()]);
