...
class CreateTrunkingPaymentTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trunking_payment_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trunking_payment_transactions');
    }
}
