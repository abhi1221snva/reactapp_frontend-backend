...
<div class="content">
    <table width="100%" style="background:#fff;border-left:1px solid #e4e4e4;border-right:1px solid #e4e4e4;border-bottom:1px solid #e4e4e4;font-family:Arial,Helvetica,sans-serif" border="0" cellpadding="0" cellspacing="0" align="center">
      ...
      <tr>
          ...
          <td align="left" valign="top"><div style="padding: 7px 12px 8px 8px;">Hello {{$data["first_name"]}} ,<br>
You have received one Fax document from {{$data["did"]}} on your Fax number {{$data["dialednumber"]}}. Please  <a href="http://phone.performancemedia.cloud/">login</a> to portal to download the fax document in a PDF format.</div></td>
      </tr>
