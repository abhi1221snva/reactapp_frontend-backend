        ...
        <div style="padding: 0px; width: 100%;">
          ...
          <table cellspacing="12" cellpadding="2" bgcolor="#FFFFFF" align="center" width="100%" border="0">
           ...
           <!--  </td>
            ...
            <tr>
            <td> -->
            <p align="left" style="margin-top: -8px;"><font size="2" face="Arial, Helvetica, sans-serif">Hello User,            <br><br>
                 
               
                

            
            <p>Your One Time Verification Code (OTP) is <b style="font-size:15px;">{{$data['otp']}}</b> to SIGN UP.</p>

            <p>This Verification Code is valid for 15 minutes or 1 successful attempt whichever is earlier.</p>
            <br><br>
            <!-- Thanks<br>
