    ...
    <div class="content">
        <div style="padding: 0px; width: 100%;">
          ...
          <table width="100%">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0"><tbody><tr><td valign="middle" width="20%"><img src="{{env('WEBSITE_LOGO')}}" alt="Logo" height="54" class="CToWUd">
            </td>
            ...
            <br><br>
            You registered an account on {{env('WEBSITE_COMPANY_NAME')}}, before being able to use your account you need to verify that this is your email address by clicking here:
            <br>
