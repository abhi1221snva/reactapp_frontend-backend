    ...
    <div class="content">
        ...
        <div style="padding: 0px; width: 100%;">
          ...
          <table cellspacing="12" cellpadding="2" bgcolor="#FFFFFF" align="center" width="100%" border="0">
            ...
            <tr>
            <td>
            <p align="left" style="margin-top: -8px;"><font size="2" face="Arial, Helvetica, sans-serif">Dear Admin,            <br><br>

                We have received one registration request from portal with below details.
            ...
            <table class="css" style="width: 50%;">
                ...
                <tr>
                    ...
                    <td class="css">{{ $data["userInfo"]["name"] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="css">Phone Number</th>
                    <td class="css">{{ $data["userInfo"]["phone_number"] }}</td>
                </tr>
                <tr>
                    <th class="css">Company Name</th>
                    <td class="css">{{ $data["userInfo"]["company_name"] }}</td>
                </tr>
